...
@class WXGCDAsyncReadPacket;
@class WXGCDAsyncWritePacket;
@class WXGCDAsyncSocketPreBuffer;
@protocol WXGCDAsyncSocketDelegate;

NS_ASSUME_NONNULL_BEGIN

extern NSString *const WXGCDAsyncSocketException;
extern NSString *const WXGCDAsyncSocketErrorDomain;

extern NSString *const WXGCDAsyncSocketQueueName;
extern NSString *const WXGCDAsyncSocketThreadName;

extern NSString *const WXGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const WXGCDAsyncSocketUseCFStreamForTLS;
#endif
#define WXGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define WXGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define WXGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const WXGCDAsyncSocketSSLPeerID;
extern NSString *const WXGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const WXGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const WXGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const WXGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const WXGCDAsyncSocketSSLCipherSuites;
extern NSString *const WXGCDAsyncSocketSSLALPN;
#if !TARGET_OS_IPHONE
extern NSString *const WXGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define WXGCDAsyncSocketLoggingContext 65535


typedef NS_ERROR_ENUM(WXGCDAsyncSocketErrorDomain, WXGCDAsyncSocketError) {
    WXGCDAsyncSocketNoError = 0,           // Never used
    WXGCDAsyncSocketBadConfigError,        // Invalid configuration
    WXGCDAsyncSocketBadParamError,         // Invalid parameter was passed
    WXGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
    WXGCDAsyncSocketReadTimeoutError,      // A read operation timed out
    WXGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
    WXGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
    WXGCDAsyncSocketClosedError,           // The remote peer closed the connection
    WXGCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface WXGCDAsyncSocket : NSObject

/**
 * WXGCDAsyncSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, WXGCDAsyncSocket will automatically create it's own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<WXGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<WXGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

/**
 * Create WXGCDAsyncSocket from already connect BSD socket file descriptor
 **/
...
+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<WXGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq error:(NSError**)error;

+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<WXGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq error:(NSError **)error;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<WXGCDAsyncSocketDelegate> delegate;
...
- (void)getDelegate:(id<WXGCDAsyncSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<WXGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
 ...
 **/
- (void)synchronouslySetDelegate:(nullable id<WXGCDAsyncSocketDelegate>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<WXGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 *
 * For accepting incoming connections, this means WXGCDAsyncSocket automatically supports both protocols,
 * and can simulataneously accept incoming connections on either protocol.
 *
 * For outgoing connections, this means WXGCDAsyncSocket can connect to remote hosts running either protocol.
 * If a DNS lookup returns only IPv4 results, WXGCDAsyncSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, WXGCDAsyncSocket will automatically use IPv6.
...
@property (atomic, assign) BOOL skipWriteTimeout;

#pragma mark Accepting

/**
 * Tells the socket to begin listening and accepting connections on the given port.
 * When a connection is accepted, a new instance of WXGCDAsyncSocket will be spawned to handle it,
 ...
 *
 * Please note the recommended way of releasing a WXGCDAsyncSocket instance (e.g. in a dealloc method)
 ...
 * it is treated similarly to a timeout - the socket is closed with a WXGCDAsyncSocketReadMaxedOutError.
 ...
 * This is due to the fact that WXGCDAsyncSocket does NOT copy the data. It simply retains it.
 ...
 *
 * - WXGCDAsyncSocketManuallyEvaluateTrust
 ...
 *     So WXGCDAsyncSocket will invoke the delegate method socket:shouldTrustPeer: passing the SecTrustRef.
 *
 ...
 *
 * - WXGCDAsyncSocketUseCFStreamForTLS (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     By default WXGCDAsyncSocket will use the SecureTransport layer to perform encryption.
 ...
 *
 *     However, if you absolutely must, you can instruct WXGCDAsyncSocket to use the old-fashioned encryption
 *     technique by going through the CFStream instead. So instead of using SecureTransport, WXGCDAsyncSocket
 ...
 *
 *     Thus all the other keys in the given dictionary will be ignored by WXGCDAsyncSocket,
 ...
 *
 * - WXGCDAsyncSocketSSLProtocolVersionMin
 * - WXGCDAsyncSocketSSLProtocolVersionMax
 ...
 *
 * - WXGCDAsyncSocketSSLSessionOptionFalseStart
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionFalseStart.
 *
 * - WXGCDAsyncSocketSSLSessionOptionSendOneByteRecord
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionSendOneByteRecord.
 *
 * - WXGCDAsyncSocketSSLCipherSuites
 ...
 *
 * - WXGCDAsyncSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see WXGCDAsyncSocketManuallyEvaluateTrust).
 ...
 *     You MUST use WXGCDAsyncSocketSSLProtocolVersionMin & WXGCDAsyncSocketSSLProtocolVersionMin instead.
...
/**
 * WXGCDAsyncSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 * - (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(WXGCDAsyncSocket *)sock
 * {
 ...
 *     return socketQueue;
 * }
 * - (void)socket:(WXGCDAsyncSocket *)sock didAcceptNewSocket:(WXGCDAsyncSocket *)newSocket
 * {
 ...
 * Example usage:
 *
 * - (void)socket:(WXGCDAsyncSocket *)sock didConnectToHost:(NSString *)host port:(uint16_t)port
 * {
...
@protocol WXGCDAsyncSocketDelegate <NSObject>
@optional
 ...
 **/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(WXGCDAsyncSocket *)sock;
 ...
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(WXGCDAsyncSocket *)sock didConnectToUrl:(NSURL *)url;

/**
 * Called when a socket has completed reading the requested data into memory.
 * Not called if there is an error.
 **/
- (void)socket:(WXGCDAsyncSocket *)sock didReadData:(NSData *)data withTag:(long)tag;
 ...
 **/
- (void)socket:(WXGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;

/**
 * Called when a socket has completed writing the requested data. Not called if there is an error.
 **/
- (void)socket:(WXGCDAsyncSocket *)sock didWriteDataWithTag:(long)tag;

/**
 * Called when a socket has written some data, but has not yet completed the entire write.
 * It may be used for things such as updating progress bars.
 **/
- (void)socket:(WXGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
 ...
 **/
- (NSTimeInterval)socket:(WXGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
 ...
 **/
- (NSTimeInterval)socket:(WXGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                 elapsed:(NSTimeInterval)elapsed
               bytesDone:(NSUInteger)length;
 ...
 **/
- (void)socketDidCloseReadStream:(WXGCDAsyncSocket *)sock;
 ...
 *
 * Note: If the WXGCDAsyncSocket instance is deallocated while it is still connected,
 ...
 **/
- (void)socketDidDisconnect:(WXGCDAsyncSocket *)sock withError:(nullable NSError *)err;
 ...
 **/
- (void)socket:(WXGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
