...
extern NSString *const WXGCDAsyncUdpSocketException;
extern NSString *const WXGCDAsyncUdpSocketErrorDomain;

extern NSString *const WXGCDAsyncUdpSocketQueueName;
extern NSString *const WXGCDAsyncUdpSocketThreadName;

typedef NS_ERROR_ENUM(WXGCDAsyncUdpSocketErrorDomain, WXGCDAsyncUdpSocketError) {
	WXGCDAsyncUdpSocketNoError = 0,          // Never used
	WXGCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	WXGCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	WXGCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	WXGCDAsyncUdpSocketClosedError,          // The socket was closed
	WXGCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class WXGCDAsyncUdpSocket;

@protocol WXGCDAsyncUdpSocketDelegate <NSObject>
@optional
...
**/
- (void)udpSocket:(WXGCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(WXGCDAsyncUdpSocket *)sock didNotConnect:(NSError * _Nullable)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(WXGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(WXGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(WXGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(WXGCDAsyncUdpSocket *)sock withError:(NSError  * _Nullable)error;
 ...
 * Example:
 * 
 * WXGCDAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^WXGCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^WXGCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface WXGCDAsyncUdpSocket : NSObject

/**
 * WXGCDAsyncUdpSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, WXGCDAsyncSocket will automatically create its own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<WXGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<WXGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

#pragma mark Configuration

- (nullable id<WXGCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id<WXGCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id<WXGCDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id<WXGCDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<WXGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<WXGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * This means WXGCDAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, WXGCDAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, WXGCDAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, WXGCDAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that WXGCDAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about WXGCDAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(nullable WXGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable WXGCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * WXGCDAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, WXGCDAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about WXGCDAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable WXGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable WXGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The WXGCDAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally WXGCDAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
